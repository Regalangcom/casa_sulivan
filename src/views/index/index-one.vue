<template>
  <div>
    ...
    <swiper
      ...
      :autoplay="{ delay: 3000 }"
      class="carousel-slider-four owl-carousel block"
    >
      <swiper-slide
        class="relative pt-12 md:pt-20 xl:pt-[100px] pb-12 sm:pb-20 xl:pb-24 px-[15px] sm:px-12 bg-[#F5F5F5] dark:bg-title"
      >
        <div class="max-w-[1720px] mx-auto">
          <div class="absolute top-5 right-[30%] z-10 hidden lg:block shape-01">
            <svg
              class="w-[300px] xl:w-[500px] h-[250px] xl:h-[409px]"
              viewBox="0 0 501 410"
              fill="none"
            ...
            <div class="absolute top-1/4 left-[10%] xl:left-[20%] z-30">
              <h4 class="leading-none text-primary dark:text-primary font-semibold">
                $140
              </h4>
          ...
          <div
            class="absolute z-10 right-[10%] xl:right-[40%] bottom-1/4 hidden md:block shape-02"
          >
            <svg
              width="101"
              height="83"
            ...
            <div
              class="text-center absolute top-1/2 left-1/2 transform z-30 -translate-x-1/2 -translate-y-1/2"
            >
          ...
          <div class="flex items-center justify-between gap-8 flex-col sm:flex-row">
            <div class="relative z-10 sm:max-w-[632px] w-full slider-content">
              ...
              >
                Brand-New Arrival Alert Your Next Favorite is Here!
              </h2>
              <p
                class="dark:text-white-light mt-3 md:mt-4 sm:max-w-[450px] xl:max-w-full"
              >
                Discover the latest must-have arrivals! Elevate your style with our newest
                collection of trendsetting items. Find your perfect fit with our diverse
                product.
              </p>
              <div class="button mt-4 md:mt-6">
                <router-link class="btn btn-outline" to="/shop-v1" data-text="Shop Now"
                  ><span>Shop Now</span></router-link
                >
              </div>
            </div>
      ...
      <swiper-slide
        class="relative pt-12 md:pt-20 xl:pt-[100px] pb-12 sm:pb-24 px-[15px] sm:px-12 bg-[#F5F5F5] dark:bg-title"
      >
        <div class="max-w-[1720px] mx-auto">
          <div class="absolute top-5 right-[30%] z-10 hidden lg:block shape-01">
            <svg
            ...
            <div class="absolute top-1/4 left-[10%] xl:left-[20%] z-30">
              <h4 class="leading-none text-[#627952] dark:text-[#627952] font-semibold">
                $110
              </h4>
          ...
          <div class="flex items-center justify-between gap-8 flex-col sm:flex-row">
            <div class="relative z-10 sm:max-w-[632px] w-full slider-content">
              ...
              <h2
                class="mt-[10px] font-normal text-3xl sm:text-4xl xl:text-5xl !leading-[1.3] dark:text-white"
              >
                Exciting New Arrivals Unmissable Just Landed
              </h2>
              <p
                class="dark:text-white-light mt-3 md:mt-4 sm:max-w-[450px] xl:max-w-full"
              >
                Discover stylish and high-quality furniture to transform your home. Shop
                from top brands and enjoy exclusive discounts on timeless designs. Elevate
                your living space today!
              </p>
              <div class="button mt-4 md:mt-6">
                <router-link class="btn btn-outline" to="/shop-v2" data-text="Shop Now"
                  ><span>Shop Now</span></router-link
                >
              </div>
            </div>
    ...
    <div class="s-py-50-100">
      <div class="container-fluid">
        ...
        >
          ...
          <p class="mt-3">
            Be the first to experience innovation with our latest arrivals. Stay ahead of
            the curve and discover what's new in style, technology, and more.
          </p>
        </div>
        ...
        <div class="max-w-[1720px] mx-auto">
          <div class="max-w-[1186px] ml-auto">
            <div class="max-w-xl mb-8 md:mb-12" data-aos="fade-up">
              ...
              <p class="mt-3">
                Choose us for unparalleled quality, exceptional service, and a commitment
                to your satisfaction. Join countless others who rely on us for
                reliability.
              </p>
            </div>
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-[30px]">
              <div
                v-for="(item, index) in featureOne.slice(0, 4)"
                :key="index"
                class="why-choose-card p-6 rounded-[10px]"
                data-aos="fade-up"
                :ata-aos-delay="item.delay"
              >
                <img :src="item.image" class="size-12" alt="" />
                <h4 class="font-semibold leading-none mt-5 sm:mt-7 text-xl md:text-2xl">
                  {{ item.title }}
                </h4>
    ...
    <div class="s-py-100-50">
      <div class="container-fluid">
        <div class="max-w-xl mx-auto mb-8 md:mb-12 text-center" data-aos="fade-up">
          ...
          <p class="mt-3">
            Discover our handpicked selection of standout products. Elevate your lifestyle
            with our top picks that combine quality, style, and innovation.
          </p>
        </div>
        <div
        ...
        >
          <LayoutOne
            :productList="productList.slice(8, 12)"
            :classList="'grid sm:grid-cols-2 gap-5 sm:gap-8 lg:max-w-[766px] w-full'"
          />
            ...
            <div class="group flex flex-col">
              <div class="relative overflow-hidden flex-1">
                ...
                >
                  ...
                  >
                    <i
                      class="mdi mdi-cards-heart-outline dark:text-white text-[24px]"
                    ></i>
      ...
      <div class="container-fluid">
        <div class="max-w-[1720px] mx-auto">
          <div class="max-w-xl mx-auto mb-8 md:mb-12 text-center" data-aos="fade-up">
            ...
            <p class="mt-3">
              Stay informed and inspired with our latest blog posts. Explore insightful
              content that keeps you ahead of trends and informed on topics you love.
            </p>
          </div>
    ...
    <div class="s-py-50-100">
      <div class="container-fluid">
        <div class="max-w-xl mx-auto mb-8 md:mb-12 text-center" data-aos="fade-up">
          ...
          <p class="mt-3">
            Count on our trusted partnerships to deliver excellence. Collaborating with
            industry leaders ensures top-quality products and services for your
            satisfaction.
          </p>
        </div>
        <div data-aos="fade-up" data-aos-delay="100">
