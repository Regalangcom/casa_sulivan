          ...
          <div class="max-w-[562px] w-full grid sm:grid-cols-2 gap-8 md:gap-12">
            <div>
              ...
              <div class="grid grid-cols-2 gap-[15px]">
                ...
                >
                  <span class="text-title dark:text-white font-medium leading-none"
                    >Min:</span
                  >
                  <div class="relative">
                    <span
...
const selectedOption = ref("mirror");

const options = ["mirror", "table", "sofa", "chair"];
