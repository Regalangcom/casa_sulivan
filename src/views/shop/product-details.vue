          ...
          <div class="lg:max-w-[635px] w-full">
            <div class="pb-4 sm:pb-6 border-b border-bdr-clr dark:border-bdr-clr-drk">
              ...
              <div class="flex gap-4 items-center mt-[15px]">
                <span
                  class="text-lg sm:text-xl leading-none pb-[5px] text-title line-through pl-2 inline-block dark:text-white"
                ></span>
                <span class="text-2xl sm:text-3xl text-primary leading-none block"></span>
              </div>

              <div class="mt-5 md:mt-7 flex items-center gap-4 flex-wrap">
                <h4 class="text-xl md:text-[22px] font-semibold !leading-none">
                  <!-- Hurry Up! -->
                </h4>
                <div class="overflow-auto">
                  <div
                    class="py-2 px-3 bg-[#FAF2F2] rounded-[51px] flex items-end gap-[6px] w-[360px]"
                  >
                    <svg
                      class="w-[15px]"
                      height="20"
                    ...
                    <h6
                      class="text-lg font-medium leading-none !text-[#E13939] whitespace-nowrap"
                    >
                      Sale Ends :
                    </h6>
                    <div class="countdown-clock flex gap-[10px] items-center">
                      <div class="countdown-item flex">
                        <div
                          class="ci-inner text-lg font-medium leading-none text-[#E13939]"
                        >
              ...
              <p class="sm:text-lg mt-5 md:mt-7">
                Experience the epitome of relaxation with our Classic Relaxable Chair.
                Crafted with plush cushioning and ergonomic design, it offers unparalleled
                comfort for lounging or reading. Its timeless style seamlessly blends with
                any decor, while the sturdy construction ensures durability for years to
                come.
              </p>
            </div>
            <div
            ...
            >
              ...
              <div class="flex gap-4 mt-4 sm:mt-6">
                <button to="" class="btn btn-solid" data-text="Buy Product">
                  <span><a href="https://wa.link/afdqcm">Buy Product</a></span>
                </button>
              </div>
            </div>
            <div
            ...
            >
              <div class="flex gap-x-12 gap-y-3 flex-wrap">
                ...
                <h6 class="leading-none font-bold text-2xl">
                  Category :
                  <span class="text-2xl text-red-600">
                    {{
                      currentProduct && currentProduct.categorySlug
            ...
            >
              ...
              <div class="flex flex-wrap gap-[10px] md:gap-[15px] mt-5 md:mt-6">
                <router-link class="btn btn-theme-outline btn-xs" to="#" data-text="Chair"
                ...
                >
                <router-link class="btn btn-theme-outline btn-xs" to="#" data-text="Table"
                  ><span>Table</span></router-link
                >
                <router-link class="btn btn-theme-outline btn-xs" to="#" data-text="Lamp"
    ...
    <div class="s-py-50-100">
      <div class="container-fluid">
        <div class="max-w-[547px] mx-auto text-center">
          ...
          <p class="mt-3">
            Explore complementary options that enhance your experience. Discover related
