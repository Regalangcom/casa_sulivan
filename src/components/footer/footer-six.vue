<template>
  <div class="s-pt-100 2xl:pb-[100px]">
    <div class="container max-w-1366 mx-auto">
      <div class="flex flex-col 2xl:flex-row items-start justify-between gap-10">
        <div
          class="max-w-[360px] 2xl:max-w-[198px] w-full text-left sm:text-center 2xl:text-left sm:mx-auto 2xl:mx-0"
        >
          ...
          <p class="mt-[15px] hidden 2xl:block">
            © {{ year }} casa Sulivan <i class="fa-solid fa-heart text-red-600"></i> by
        ...
        <div
          class="grid grid-cols-2 sm:grid-cols-3 2xl:max-w-[1050px] w-full lg:flex items-start justify-between gap-10"
        >
          ...
          <div>
            <h4 class="leading-none mb-5 md:mb-6 text-xl">Home</h4>
            <!-- <ul class="text-title dark:text-white leading-none flex flex-col gap-4">
              ...
              >
                <a class="text-underline-primary" :to="item.link">{{ item.name }}</a>
              </li>
            </ul> -->
          </div>
          <div>
            <h4 class="leading-none mb-5 md:mb-6 text-xl">Product</h4>
            <!-- <ul class="text-title dark:text-white leading-none flex flex-col gap-4">
              <li
          ...
          <div>
            <h4 class="leading-none mb-5 md:mb-6 text-xl">Our project</h4>
            <!-- <ul class="text-title dark:text-white leading-none flex flex-col gap-4">
              <li
          ...
          <div>
            <h4 class="leading-none mb-5 md:mb-6 text-xl">Contact Us</h4>
            <!-- <ul class="text-title dark:text-white leading-none flex flex-col gap-4">
              <li
      ...
      <div class="block 2xl:hidden py-5 text-center mt-14">
        <!-- <p>
